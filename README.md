...
Go to the help on the iitiating settings files, go to [Setting up Homie](docs/2_Setup_Homie.md) and [Setting up Homebride - Apple Homekit](docs/3_Setup_HomeBridge.md). 
